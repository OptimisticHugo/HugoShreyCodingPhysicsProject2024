...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 17:37:40 2024
...
'''for testing no signalling conditions on omega. CVX general noise must be
run first in order for this code to work.'''
...
print(' mixed switch for v={:0.5f}: {:0.5f}'.format(v,ineq6(W_mixed)))

'''testing general noise from CVX. N.B. necessary to run tetra CVX first'''
W_gen_new = Qobj((W_gen.value)/(0.5453511653583725),dims=[[2,2,2,2,2,2],[2,2,2,2,2,2]])
print(total(W_gen_new))
print(W_extended.tr())
print(W_gen_new.tr())
print(ineq6(W_gen_new))

'''investigating no signalling conditions'''
print(nosig1(W_gen_new))
print(nosig2(W_gen_new))
